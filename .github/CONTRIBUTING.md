...
3. **Provide logs** &mdash; this cannot be overstated enough; bug reports
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/keyos1/plugin.video.quasar.git
   # Navigate to the newly cloned directory
   cd plugin.video.quasar
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/keyos1/plugin.video.quasar.git
   ```
